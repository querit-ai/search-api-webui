...
requirements = python3,kivy,flask==2.2.5,werkzeug==2.3.3,flask-cors,requests,pyyaml,jinja2,markupsafe,click,itsdangerous,certifi,charset-normalizer,idna,urllib3,jmespath
